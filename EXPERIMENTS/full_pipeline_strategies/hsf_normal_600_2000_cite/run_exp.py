...
exp_dir = "./EXPERIMENTS/full_pipeline_strategies/hsf_normal_600_2000_cite/"
# input_questions= "./experiment_data/dataset_v2.json"
input_questions= "./abstain_set.json"

for strategy in strategies:
    run_and_log(inputfile=input_questions, output_file=f"{exp_dir}{strategy}_cite_with_abstain_set.csv", chunk_retrieve_strategy=strategy)        

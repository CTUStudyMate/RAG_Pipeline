...
exp_dir = "./EXPERIMENTS/full_pipeline_strategies/hsf_multi_v2/"
...
for strategy in strategies:
    run_and_log(inputfile=input_questions, output_file=f"{exp_dir}{strategy}_hsfmulti_studyguide.csv", chunk_retrieve_strategy=strategy)        

...
INPUT_QUESTIONS = PROJECT_ROOT / "studyguide_based_dataset.json"
...
def run_and_log(chunk_retrieve_strategy, input_file, output_file):
    ...
    if file_exists:
        with output_file.open(mode="r", newline="", encoding="utf-8") as f:
            existing_questions = {
                row["question"]
...
if __name__ == "__main__":
    for strategy in STRATEGIES:
        run_and_log(
            ...
            output_file=(
                EXP_DIR / "stage4_hsf_multistage_v075_b025_600_2400_studyguide.csv"
            ),
        )

...
strategies = ["normal"]
exp_dir = "./EXPERIMENTS/full_pipeline_strategies/hsf_600_2000/"
input_questions= "./notebooklm_generated_dataset.json"

for strategy in strategies:
    run_and_log(inputfile=input_questions, output_file=f"{exp_dir}hsf_{strategy}_notebooklm.csv", chunk_retrieve_strategy=strategy)        
